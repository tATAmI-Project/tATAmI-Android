...
public abstract class AgentComponent implements Serializable
{
	 ...
	 */
	private Map<AgentEvent.AgentEventType, AgentEvent.AgentEventHandler>	eventHandlers;
	...
	protected AgentComponent(AgentComponentName name)
	{
		...
		// register
		eventHandlers = new HashMap<AgentEvent.AgentEventType, AgentEvent.AgentEventHandler>();
		registerHandler(AgentEvent.AgentEventType.AGENT_START, new AgentEvent.AgentEventHandler() {
		...
		registerHandler(AgentEvent.AgentEventType.SIMULATION_START, new AgentEvent.AgentEventHandler() {
		...
		registerHandler(AgentEvent.AgentEventType.SIMULATION_PAUSE, new AgentEvent.AgentEventHandler() {
		...
		registerHandler(AgentEvent.AgentEventType.AGENT_STOP, new AgentEvent.AgentEventHandler() {
	 ...
	 */
	protected boolean preload(ComponentCreationData parameters, XMLNode scenarioNode, List<String> agentPackage)
	{
		if(parameters != null)
		{
	 ...
	 */
	protected AgentEvent.AgentEventHandler registerHandler(AgentEvent.AgentEventType event, AgentEvent.AgentEventHandler handler)
	{
		AgentEvent.AgentEventHandler oldHandler = null;
	...
	*/
	 ...
	 */
	protected boolean registerMessageReceiver(AgentEvent.AgentEventHandler receiver, String... prefixElements)
	{
		...
		registerHandler(AgentEvent.AgentEventType.AGENT_MESSAGE, receiver);
		return false;
	}
