 ...
 * @author Andrei Olaru
 */
public class VisualizableComponent extends AgentComponent implements ReportingEntity, AgentActiveIO.InputListener
{
	/**
	 * Class UID.
	 */
...
//		getLog().info("arrived after move");
	...
	protected void registerMessageHandlers()
	{
		...
		if(!registerMessageReceiver(new AgentEvent.AgentEventHandler() {
	...
	public void resetVisualization()
	{
		...
		if(gui != null)
		{
			loggingUnit.setLogDisplay(new Log2AgentGui(gui, AgentGui.DefaultComponent.AGENT_LOG.toString()));
	...
	{
		AgentEvent event = new AgentEvent(AgentEvent.AgentEventType.GUI_INPUT);
		try
		{
