 ...
 ******************************************************************************/
package com.tatami.tatami_android.core.util;
 ...
 * {@link ConfigLockedException} thrown by locked methods is converted to a
...
public class ParameterSet extends SerializableConfig
{
	...
	/**
	 * Wrapper of {@link Config#locked()} that converts the {@link ConfigLockedException}
